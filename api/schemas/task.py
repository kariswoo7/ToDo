...
# -----------------------------------------------------------------
# 공통 속성 정의 (제목만 포함)
# TaskCreate, TaskCreateResponse, Task가 공통으로 사용하느 부분을 따로 묶은 클래스
# -----------------------------------------------------------------


class TaskBase(BaseModel):
    title: str | None = Field(
        None,  # 제목이 없을 수도 있으니 기본값은 None 으로 설정
...
class Task(BaseModel):  # '할 일'을 표현할 수 있는 Task라는 틀을 만든다.
    ...
    # title: 할 일의 제목
    # str 또는 None -> 글자이거나 비어 있을 수도 있다.ss
    ...
    # done: 이 할 일이 끝났는지를 표시하는 겂 (True 또는 False만 가능함)
